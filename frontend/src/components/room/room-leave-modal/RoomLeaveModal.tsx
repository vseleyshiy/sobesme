			...
			<div className={styles.info}>
				<div className={styles.header}>
					...
					<div className={styles.description}>
						<ul>
							<li>
								вами было потрачено время собеседующего вас сеньора, и поэтому
								вы не получите детальный разбор собеседования, завершив его
								принудительно.
							</li>
							<li>
								вам не перезвонят, и вы потеряете шанс на получение работы в
								этой компании...
							</li>
						</ul>
					</div>
