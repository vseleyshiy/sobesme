				...
				<div className={styles.header}>
					...
					<div className={styles.description}>
						<ul>
							...
							<li>
								Если же вы зашли в уже созданное до этого интервью, то просто
								скажите сеньору что-то типо "у меня отвалился интернет", "меня
								выкинуло" и прочее. Он поймёт и вы продолжите собеседование
							</li>
						</ul>
						<br />
						Удачи!
